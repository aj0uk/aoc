...
//            console.log('moving from',currentXY,count,'in direction',dir)
            currentXY=newLocation(map,currentXY[0],currentXY[1],count,dir)
//            console.log('stopped at',currentXY)
            dir=newDir(dir,move[c])
//            console.log('turned',move[c],'now facing',dir)
            count=""
        } else count=count+move[c]
    }
    currentXY=newLocation(map,currentXY[0],currentXY[0],parseInt(count),dir)
